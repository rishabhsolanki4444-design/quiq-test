export const postComponents: Record<string, () => Promise<{ default: React.ComponentType<any> }>> = {
  ...
  'vitamin-d-deficiency-signs-india': () => import('@/content/blog/en/vitamin-d-deficiency-signs-india.mdx'),
  'can-you-check-thyroid-at-home-india': () => import('@/content/blog/en/can-you-check-thyroid-at-home-india.mdx'),
  'blood-test-without-prescription-india': () => import('@/content/blog/en/blood-test-without-prescription-india.mdx'),
}
